function add_new_form(
    ...
    // var idOfSelect = copyemptyFormEl.find('#id_cameraptsconstructor_set-0-brend')


    // idOfSelect.change(function () {
    //   console.log('camId');

    //   var url = $("#cfgForm").attr("data-cam-url");  // get the url of the `load_cities` view
    ...
    //     data: {
    //       'camera_models': camId       // add the country id to the GET parameters
    //     },
    //     success: function (data) {   // `data` is the return of the `load_cities` view function
    //       $("#id_cameraptsconstructor_set-0-model").html(data);  // replace the contents of the city input with the data that came from the server
    //     }
    //   });
    // });
  }
